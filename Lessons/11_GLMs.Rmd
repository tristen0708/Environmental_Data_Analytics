...
> ANWSER: Ozone AQI values are significantly lower than 50 (t-test; t = -41.9, df = 184, p < 0.0001)
...
O3.onesample.wilcox #gives u a V
O3.twosample.wilcox <- wilcox.test(EPAair$Ozone ~ EPAair$Site.Name)
O3.twosample.wilcox #gives u a W - may want to use if you have departed from normality a lot
```
...
# How might you illustrate significant differences? Could put a star abouce blackstone or could group bryson and triple as B and make blackstone group A
...
> ANSWER: Blackstone has higher values of PM2.5 on average than Bryson City and Triple Oak (ANOVA; F = 16.16, df = 1898, p < 0.0001). Bryson City and Triple Oak did not hve significantly different values over the study period.
