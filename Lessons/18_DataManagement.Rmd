...
riverdata$Name <- str_replace(riverdata$Name, "\\[.*\\]", "") #double \\ means remove any spaces between text and brackets ; then remove any brackets and anything inside
