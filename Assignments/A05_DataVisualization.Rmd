...
Peter.Paul <- read.csv("./Data/Processed/NTL-LTER_Lake_ChemistryPhysics_PeterPaul_Processed.csv")
...
Peter.Paul$sampledate <- as.Date(Peter.Paul$sampledate, format = "%m/%d/%y")
USGS$datetime <- as.numeric(USGS$datetime, format = "%y%m%d")
#EPA.ecotox$Pub..Year <- as.Date(EPA.ecotox$Pub..Year, format = "%Y", origin="1970") #what
