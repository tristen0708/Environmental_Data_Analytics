...
shapiro.test(EPA.ecotox$Pub..Year[EPA.ecotox$Chemical.Name == "Thiacloprid"])
  ...
  group_by(Chemical.Name) %>%  
  summarise(shaptestC1 = shapiro.test(),
    shaptestC2 = shapiro.test(),
    shaptestC3 = shapiro.test(),
    shaptestC4 = shapiro.test(),
    shaptestC5 = shapiro.test(),
    shaptestC6 = shapiro.test(),
    shaptestC7 = shapiro.test(),
    shaptestC8 = shapiro.test(),
    shaptestC9 = shapiro.test()) 
